        ...
        if scope == GLOBAL_NET_SCOPE:   # get global network
            ...
            with tf.name_scope('sync'):
                ...
                with tf.name_scope('push'):
                    self.update_a_op = OPT_A.apply_gradients(list(zip(self.a_grads, globalAC.a_params)))
                    self.update_c_op = OPT_C.apply_gradients(list(zip(self.c_grads, globalAC.c_params)))
