...
class RL_PI2:
    ...
    def training(self):
        ...
        if self.plot_photo and self.current_training !=0:
            ...
            plt.show()
        for it in range(self.current_training,101):
    ...
    def rolling_optimization(self,rolling_time=20,total_step=200):
        ...
        while iterator < opt_times :
            ...
            self.training()
            max_time = max(max_time,self.current_training)
            K_list.append(self.K_after_training)
            loss_list.append(self.loss_after_training)
        ...
        return alpha_list,delta_z_list,theta_list,theta_desired_list,K_list,loss_list,max_time
